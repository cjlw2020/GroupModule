...
las1 <- readLAS("/var/folders/7g/dn_1ng7x3rvgnnf8c97vn_6h0000gp/T//RtmpxdwhDl/file51f47e53737d.las") #you might need to change this to the path given in the output above under 'saved locally as:'
las2 <- readLAS("/var/folders/7g/dn_1ng7x3rvgnnf8c97vn_6h0000gp/T//RtmpxdwhDl/file51f418c35456.las")
...
dsm2 <- projectRaster(dsm1, crs = crs(BU_buildings_shp))
dsm3 <- crop(dsm2, BU_buildings_shp) 
...
las.bc1 <- readLAS("/var/folders/7g/dn_1ng7x3rvgnnf8c97vn_6h0000gp/T//RtmpxdwhDl/file51f45a0f2522.las") #you might need to change this to the path given in the output above under 'saved locally as:'
